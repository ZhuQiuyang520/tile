...
namespace excel2json
{
    ...
    class CSDefineGenerator
    {
        ...
        public CSDefineGenerator(string excelName, ExcelLoader excel, string excludePrefix, string _code)
        {
            //-- 创建代码字符串
            ...
            sb.AppendLine();
            sb.AppendLine("namespace zeta_framework");
            sb.AppendLine("{");
            sb.AppendLine();
        ...
        private string _exportSheet(DataTable sheet, string excludePrefix)
        {
            ...
            {
                tableName = tableName.Replace("<T>", "") + "DB" + "<T>";
            }
            else
            {
