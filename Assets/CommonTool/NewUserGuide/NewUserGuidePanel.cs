...
public class NewUserGuidePanel : BaseUIForms
{
    public static NewUserGuidePanel instance;
    ...
    public void Init(GameObject _target)
    {
        ...
        else
        {
            ...
            corners[0] = new Vector3(pos.x - targetWidth, pos.y - targetHeight);
            corners[1] = new Vector3(pos.x - targetWidth, pos.y + targetHeight);
            corners[2] = new Vector3(pos.x + targetWidth, pos.y + targetHeight);
            corners[3] = new Vector3(pos.x + targetWidth, pos.y - targetHeight);
        }
        //计算高亮显示区域在画布中的范围
