...
{
    public class OilyRefinerRule : SettingDB
    {
        public static OilyRefinerRule Instance;

        public OilyRefinerRule(JsonData setting)
        {
            if (Instance == null)
            {
                Instance = this;
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public T PenRefinerOnOf<T>(string id)
        {
