...
{
	public SkillfulInputGiftRule DailyGift { get; set; } // 签到奖励
	public SkillfulHyksosToRule RemoveAd { get; set; } // 去广告
	public Activity GoldBox { get; set; } // 金箔宝箱
	public SkillfulSixteenIdentifyRule EndlessTreasure { get; set; } // 无尽宝藏
