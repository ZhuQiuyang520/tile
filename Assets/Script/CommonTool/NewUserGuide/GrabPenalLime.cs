...
/// 矩形遮罩镂空
/// </summary>
public class GrabPenalLime : MonoBehaviour
{
    public static GrabPenalLime instance;
[UnityEngine.Serialization.FormerlySerializedAs("Hand")]    public GameObject Open;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    public void Bull(GameObject _target)
    {
        ...
        else
        {
            ...
            float width = 1;
            float height = 1;
            Explain[0] = new Vector3(pos.x - width, pos.y - height);
            Explain[1] = new Vector3(pos.x - width, pos.y + height);
            Explain[2] = new Vector3(pos.x + width, pos.y + height);
            Explain[3] = new Vector3(pos.x + width, pos.y - height);
        }
        //计算高亮显示区域在画布中的范围
