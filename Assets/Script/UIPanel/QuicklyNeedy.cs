...
public class QuicklyNeedy : BaseUIForms
{
...
[UnityEngine.Serialization.FormerlySerializedAs("TryBtn")]
    ...
    private void ThreadMapAgain()
    {
        ...
        {
            PostEventScript.GetInstance().SendEvent("1025", RaftNonself.GetInstance().ActCharacterBread().ToString());
            PostEventScript.GetInstance().SendEvent("1033", RaftNonself.GetInstance().ActCharacterBread().ToString(), RaftNonself.GetInstance().Slowly.ToString());
            ...
            PostEventScript.GetInstance().SendEvent("1029", RaftNonself.GetInstance().ActCharacterBread().ToString(), str.ToString());
            PostEventScript.GetInstance().SendEvent("1038", RaftNonself.GetInstance().ActCharacterBread().ToString(), str.ToString(), RaftNonself.GetInstance().Slowly.ToString());
            UIManager.GetInstance().ClearAllUI();
            UIManager.GetInstance().ShowUIForms(nameof(RaftNeedy));
            RaftNonself.GetInstance().OrganPreferable(StartChallengeState.SettingTryAgain);
        }
        else
        {
            CloseUIForm(GetType().Name);
