...
{
    public static class PartialOnwardSieve
    {
        public static T PenAgainOnBear<T>(string name = "") where T : Object
        {
#if UNITY_EDITOR
        ...
        public static void LayChalk(Object obj)
        {
#if UNITY_EDITOR
        ...
        public static void PhysicPersonally(this GameObject gameObject, bool state)
        {
#if UNITY_EDITOR
        ...
        public static void PhysicEpithet(this GameObject gameObject, bool state)
        {
#if UNITY_EDITOR
