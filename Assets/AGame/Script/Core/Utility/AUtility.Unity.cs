...
public static partial class AUtility
{
    ...
    {
        private static IAUpdateDriver _updateDriver;
        ...
        public static GameCoroutine StartCoroutine(string name, IEnumerator routine, MonoBehaviour bindBehaviour)
        {
            ...
            {
                ADebug.Error($"StartCoroutine {name} failed, bindBehaviour is null");
                return null;
            }
        ...
        public static GameCoroutine StartCoroutine(string name, IEnumerator routine, GameObject bindGo)
        {
            if (bindGo == null)
            {
                ADebug.Error($"StartCoroutine {name} failed, BindGo is null");
                return null;
            }
        ...
        private static void _MakeEntity()
        {
            ...
            _updateDriver = AUpdateDriver.Instance;
        }
