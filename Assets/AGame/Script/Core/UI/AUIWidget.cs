...
public abstract class AUIWidget : AUIBase
{
    /// <summary>
    /// 窗口组件名称。
    /// </summary>
    ...
    /// <returns></returns>
    // public bool Create(AUIBase parentUI, GameObject widgetRoot, bool visible = true)
    // {
    ...
    /// <returns></returns>
    // public bool CreateByPath(string resPath, AUIBase parentUI, Transform parentTrans = null, bool visible = true)
    // {
    ...
    // public bool CreateByPrefab(AUIBase parentUI, GameObject goPrefab, Transform parentTrans, bool visible = true)
    // {
    //     if (parentTrans == null)
    //     {
    //         parentTrans = parentUI.GetComponent<RectTransform>();
    //     }
    //
    //     return CreateImp(parentUI, Object.Instantiate(goPrefab, parentTrans), true, visible);
    // }

    // private bool CreateImp(AUIBase parentUI, GameObject widgetRoot, bool bindGo, bool visible = true)
    // {
    ...
    // protected void RestChildCanvas(AUIBase parentUI)
    // {
